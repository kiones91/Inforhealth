# Gestão de Contratos e Negociação na Saúde Suplementar

> Fonte: https://edu.inforhealth.com.br/gestao-contratos-negociacao-saude-suplemen/

**Modalidade:** Ao Vivo

![Formação em Gestão de Contratos e Negociação na Saúde Suplementar](../imagens/cursos/formacao-gestao-contratos-negociacao.webp)

## Resumo

Capacite-se para negociar contratos com operadoras. Regras ANS, modelos de remuneração, KPIs e simulações práticas | 16h | Vagas limitadas

## Seções da página

- Formação em Gestão de Contratos e Negociação na Saúde Suplementar
- Capacite-se para negociar contratos com operadoras. Regras ANS, modelos de remuneração, KPIs e simulações práticas
- Garanta sua vaga agora!
- Por que fazer o curso de Gestão de Contratos e Negociação na Saúde Suplementar?
...
- Administradores hospitalares, coordenadores de contratos, faturamento, custos e controladoria
- clínicas, hospitais, laboratórios
- e auditores saúde suplementar e hospitalar
